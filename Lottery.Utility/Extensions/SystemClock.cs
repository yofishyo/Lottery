...
namespace Lottery.Utility.Extensions
{
    public sealed class SystemClock : IDisposable
    {
        ...
        /// <summary>
        /// Gets the flag indicating whether the instance of <see cref="SystemClock"/> provides high resolution time.
        /// <remarks>
        /// <para>
        ...
        /// </remarks>
        /// </summary>
        public static bool IsPrecise { get; }
        ...
        /// <summary>
        /// Releases all resources used by the instance of <see cref="SystemClock"/>.
        /// </summary>
        public void Dispose()
        {
            _startTime.Dispose();
